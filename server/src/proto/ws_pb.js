...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.songs.RemoveFromRoomRequest.displayName = 'proto.songs.RemoveFromRoomRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.songs.AddToRoomRequest.prototype.toObject = function(opt_includeInstance) {
 ...
 * @return {!proto.songs.AddToRoomRequest}
 */
proto.songs.AddToRoomRequest.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.songs.AddToRoomRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Object}
 */
proto.songs.RemoveFromRoomRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.songs.RemoveFromRoomRequest.toObject(opt_includeInstance, this);
};
...
proto.songs.RemoveFromRoomRequest.deserializeBinary = function(bytes) {
  ...
  return proto.songs.RemoveFromRoomRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.songs.RemoveFromRoomRequest}
 */
proto.songs.RemoveFromRoomRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.songs.RemoveFromRoomRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNamespace();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {!Object}
 */
proto.songs.EmitMessageRequest.prototype.toObject = function(opt_includeInstance) {
...
proto.songs.EmitMessageRequest.deserializeBinary = function(bytes) {
  ...
  return proto.songs.EmitMessageRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.songs.EmitMessageRequest}
 */
proto.songs.EmitMessageRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.songs.EmitMessageRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getNamespace();
  if (f.length > 0) {
    writer.writeString(
