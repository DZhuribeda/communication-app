...
interface IWebsocketsService_IAddToRoom
  extends grpc.MethodDefinition<
    ws_pb.AddToRoomRequest,
...
interface IWebsocketsService_IRemoveFromRoom
  extends grpc.MethodDefinition<
    ws_pb.RemoveFromRoomRequest,
    google_protobuf_empty_pb.Empty
  > {
...
interface IWebsocketsService_IEmitMessage
  extends grpc.MethodDefinition<
    ws_pb.EmitMessageRequest,
    google_protobuf_empty_pb.Empty
  > {
...
export interface IWebsocketsServer extends grpc.UntypedServiceImplementation {
  addToRoom: grpc.handleUnaryCall<
    ws_pb.AddToRoomRequest,
    google_protobuf_empty_pb.Empty
  >;
  removeFromRoom: grpc.handleUnaryCall<
    ws_pb.RemoveFromRoomRequest,
    google_protobuf_empty_pb.Empty
  >;
  emitMessage: grpc.handleUnaryCall<
    ws_pb.EmitMessageRequest,
    google_protobuf_empty_pb.Empty
  >;
}
...
export interface IWebsocketsClient {
  addToRoom(
    request: ws_pb.AddToRoomRequest,
    callback: (
  ...
  removeFromRoom(
    request: ws_pb.RemoveFromRoomRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: google_protobuf_empty_pb.Empty
    ) => void
  ...
  emitMessage(
    request: ws_pb.EmitMessageRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: google_protobuf_empty_pb.Empty
    ) => void
