...
export class RemoveFromRoomRequest extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: RemoveFromRoomRequest): RemoveFromRoomRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: RemoveFromRoomRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): RemoveFromRoomRequest;
    static deserializeBinaryFromReader(message: RemoveFromRoomRequest, reader: jspb.BinaryReader): RemoveFromRoomRequest;
}
...
export class EmitMessageRequest extends jspb.Message { 
    ...
    static toObject(includeInstance: boolean, msg: EmitMessageRequest): EmitMessageRequest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: EmitMessageRequest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): EmitMessageRequest;
    static deserializeBinaryFromReader(message: EmitMessageRequest, reader: jspb.BinaryReader): EmitMessageRequest;
}
